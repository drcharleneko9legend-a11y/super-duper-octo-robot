    ...
    <div className="min-h-screen bg-[#0A0A0B] text-white font-sans selection:bg-[#FF4C00] selection:text-black">
      ...
      <nav className="flex items-center justify-between px-6 py-4 md:px-12 bg-black/50 backdrop-blur-md sticky top-0 z-50 border-b border-zinc-800">
        <div className="flex items-center gap-3">
          ...
          <span className="font-black text-2xl tracking-tighter text-white">WARRIOR <span className="text-[#FF4C00]">VITALITY</span></span>
        </div>
        ...
        <button className="bg-[#FF4C00] text-black px-6 py-2 rounded-full font-black text-sm uppercase tracking-tighter hover:scale-105 transition shadow-[0_0_15px_rgba(255,76,0,0.35)]">
          Join Now
        </button>
      </nav>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <button className="bg-[#FF4C00] text-black px-8 py-4 rounded-full font-black text-xl uppercase tracking-tighter hover:scale-105 transition flex items-center gap-2 shadow-[0_0_20px_rgba(255,76,0,0.4)]">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12 bg-[#18181C] border border-zinc-800 rounded-[3rem] overflow-hidden">
          ...
          <div className="flex-1 p-8 md:p-16 space-y-12 relative overflow-hidden flex flex-col justify-center">
            ...
            <div className="space-y-6">
              ...
              <button className="block w-full bg-[#FF4C00] text-black py-6 rounded-2xl font-black text-2xl uppercase tracking-tighter hover:scale-[1.02] transition shadow-xl shadow-[#FF4C00]/10">
                Join The Challenge
              </button>
            </div>
          </div>
